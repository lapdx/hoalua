            ...
            <div class="checkout-form form form-horizontal">
                <form action="<?= route("frontend::order-create") ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input name="delivery_address" value="{{ old('delivery_address') }}" type="text" class="form-control">
                        </div>
                    </div><!-- form-group -->
                    <div class="form-group">
                        <label class="control-label col-sm-4">Ghi chú</label>
                        <div class="col-sm-8">
                            <textarea name="note" value="{{ old('note') }}" cols="" rows="3" class="form-control"></textarea>
                        </div>
                    </div><!-- form-group -->
                    <div class="form-group">
