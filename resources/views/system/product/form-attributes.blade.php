    ...
    <div class="modal-dialog modal-lg" role="document" style="margin-top:10px;margin-bottom:10px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Thuộc tính lọc</h4>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6" >
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Thuộc tính lọc</label>
                                            <div class="col-md-9">
                                                <select multiple class="form-control js-multiple-select" ng-model="product.attribute_values" tabindex="1" ng-options="item.content_value for item in attribute_values track by item.id">
                                                </select>
                                            </div>
                                        </div>
                                    </div>
