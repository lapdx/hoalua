@extends('system.layouts.main', ['title' => 'Setting Management'])
...
<script type="text/javascript" src="/js/controller/setting-controller.js?v={{ env('APP_VERSION') }}"></script>
...
@section('content-system')
    <div class="content-wrapper" ng-controller="SettingController" >
