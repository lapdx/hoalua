    ...
    <from class="form-horizontal">
        <div class="col-md-2">
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" ng-keyup="keypressFilter($event)" ng-model="filter.title" name="title" placeholder="Tên danh mục" autofocus>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label class="control-label col-md-4">Danh mục cha: </label>
                <div class="col-md-8">
                    <select class="form-control" ng-model="filter.parent_id" ng-options="parent as parent.title for parent in parents track by parent.id" ng-change="find()">
...
<!--        <div class="col-md-2">
        ...
        <div class="col-md-3 text-center">
            <div class="form-group">
                <button type="button" class="btn btn-warning search" ng-click="find(true);" data-loading-text="<span class='fa fa-spinner fa-spin'></span> Loading..."><i class="fa fa-search"></i> Search</button>
