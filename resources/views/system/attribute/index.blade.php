@extends('system.layouts.main', ['title' => 'Filter Management'])
...
<script type="text/javascript" src="/js/controller/attribute-controller.js?v={{ env('APP_VERSION') }}"></script>
...
@section('content-system')
    <div class="content-wrapper" ng-controller="AttributeController" >
