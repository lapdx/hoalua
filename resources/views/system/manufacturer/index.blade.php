@extends('system.layouts.main', ['title' => 'Manufacturer Management'])
...
<script type="text/javascript" src="/js/controller/manufacturer-controller.js?v={{ env('APP_VERSION') }}"></script>
...
@section('content-system')
    <div class="content-wrapper" ng-controller="ManufacturerController" >
        ...
        <section class="content">
            @include('system.manufacturer.list')
        </section>
        @include('system.manufacturer.form')
    </div>
@stop
