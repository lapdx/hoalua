@extends('system.layouts.main', ['title' => 'Blog Management'])
...
<script type="text/javascript" src="/js/controller/blog-controller.js?v={{ env('APP_VERSION') }}"></script>
...
@section('content-system')
    <div class="content-wrapper" ng-controller="BlogController" >
        ...
        <section class="content">
            @include('system.blog.list')
        </section>
        @include('system.blog.form')
    </div>
@stop
