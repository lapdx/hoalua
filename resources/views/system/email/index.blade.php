@extends('system.layouts.main', ['title' => 'Email Management'])
...
<script type="text/javascript" src="/js/controller/email-controller.js?v={{ env('APP_VERSION') }}"></script>
...
@section('content-system')
    <div class="content-wrapper" ng-controller="EmailController" >
        <section class="content-header">
            <ol class="breadcrumb">
                <li><a href="/"><i class="fa fa-dashboard"></i> Home</a></li>
                <li>Management</li>
                <li class="active">Email Newsletter</li>
            </ol>
            <br />
        </section>
        <section class="content">
            @include('system.email.list')
        </section>
    </div>
@stop
